      ...
      Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              "EchoHero is an open source PoC platform for public good built for the Google Cloud Gemini Hackathon. It allows users to signal sustainability issues in their city and offers points to those who resolve them, all that while using Gemini's AI to moderate and control the user content.",
              style: TextStyle(
